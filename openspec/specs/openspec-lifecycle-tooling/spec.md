# openspec-lifecycle-tooling

## Purpose

Canonical specification for the `openspec-lifecycle-tooling` capability, promoted from change `harden-openspec-lifecycle-tooling`.
