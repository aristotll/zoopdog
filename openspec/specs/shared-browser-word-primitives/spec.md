# shared-browser-word-primitives

## Purpose

Canonical specification for the `shared-browser-word-primitives` capability, promoted from change `2026-08-11-streamline-agent-workflow-surface`.
