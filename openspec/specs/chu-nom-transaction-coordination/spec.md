# chu-nom-transaction-coordination

## Purpose

Canonical specification for the `chu-nom-transaction-coordination` capability, promoted from change `serialize-chu-nom-apply-transactions`.
