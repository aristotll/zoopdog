// REFERENCE COPY -- do not edit and do not import from production code.
//
// Frozen snapshot of zd-extension/js/zd-nom-match.js as it was before the word-level index
// rewrite (openspec/changes/speed-up-userscripts): the character-trie engine. The differential
// test in test/nom-match-equivalence.test.js runs it side by side with the live engine and
// asserts identical output, which is what makes replacing the data structure safe.
