...
// (`make minify-userscripts`). Kept apart from the builders so they, and the add-chu-nom
// workflow that runs them, never depend on esbuild; the (Local) builds are never minified
// because they are installed from disk, where size costs nothing and readability helps.
